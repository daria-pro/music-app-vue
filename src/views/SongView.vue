...
import { getDoc, doc, addDoc, query, where, getDocs, updateDoc } from 'firebase/firestore'
...
export default {
  ...
  methods: {
    ...
    async getComments() {
      const commentsQuery = query(commentsCollection, where('sid', '==', this.$route.params.id))
